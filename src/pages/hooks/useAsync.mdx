...
[See the API Reference](#api-reference) for details on these return values.
...
| :------------------ | :------------------- | :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------- |
| **`asyncFunction`** | yes                  | `AsyncFunction<T>` | The asynchronous function that you want to manage. It must be a function that returns a Promise.                                        |
