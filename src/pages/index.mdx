...
- [useCustomCSSProp](/hooks/useCustomCSSProp)\
...
- [useColorContrast](/hooks/useColorContrast)\
  Calculate the contrast ratio between two colors based on WCAG accessibility guidelines.
...
<Callout emoji='⭐️' type='info'>
  Have a suggestion for a hook that you'd like to see added to Useful? [Open an
  issue](https://github.com/ridgehkr/useful/issues/new) and let us know!
</Callout>
